...
class Model():
    ...
    def run(self, img):
        ...
        predict_text = self.decode_img(img_predict)
        return  predict_text
...
#
#     img_NAME = "1_0_LOAN.png"
#     path_NAME = f"/home/huyphuong99/PycharmProjects/project_graduate/data/NAME/{img_NAME}"
...
#     model_NAME = Model(path_NAME, vocab_NAME, img_w_NAME, img_h_NAME, max_len_NAME, path_model_NAME)
